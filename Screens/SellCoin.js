...
export const SellCoinScreen = ({navigation, route}) => {
  const [isSelected, setisSelected] = React.useState(null);
  const [ammount, setAmmount] = React.useState('');
  const [col, setCol] = useState('#41BC00');
    ...
    <ScrollView style={styles.container}>
      <View style={styles.BalanceSheetContainer}>
        <View style={styles.TopBalanceContainer}>
          <Text style={styles.TopHeadCurrency}>Sell</Text>
          <View>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.Trade_Button_Text}>Sell</Text>
      </TouchableOpacity>
